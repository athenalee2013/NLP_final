...
from keras.layers import Input, Dense, Dense, Dropout, Activation, Flatten, concatenate
from keras.layers import Embedding
from keras.layers import Convolution1D, MaxPooling1D, GlobalMaxPooling1D, GlobalMaxPooling2D, LeakyReLU
...
parser.add_argument("--model_name", type=str, default='model_best.h5', help="saving model name")
...
for epoch in range(nb_epoch):       
    model.fit([sentenceTrain, positionTrain1, positionTrain2], yTrain, batch_size=batch_size, verbose=True,epochs=1, validation_split=0.05)   
